  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fs-control absolute bottom-3 left-3 z-10 grid size-8 place-items-center rounded-sm bg-background/30 text-foreground/40 opacity-60 backdrop-blur-[2px] transition hover:bg-background/70 hover:text-foreground hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:bg-background/15 dark:text-foreground/25 dark:opacity-40 dark:hover:bg-background/50 dark:hover:text-foreground/80 dark:hover:opacity-100"
      >
        {isFs ? (
